...
设置 m7-devops-128071 可以无密码登录**所有节点**的 k8s 和 root 账户：

``` bash
[k8s@m7-devops-128071 k8s]$ ssh-keygen -t rsa
[k8s@m7-devops-128071 k8s]$ ssh-copy-id root@m7-devops-128071
[k8s@m7-devops-128071 k8s]$ ssh-copy-id root@m7-devops-128107
[k8s@m7-devops-128071 k8s]$ ssh-copy-id root@m7-devops-128123

[k8s@m7-devops-128071 k8s]$ ssh-copy-id k8s@m7-devops-128071
[k8s@m7-devops-128071 k8s]$ ssh-copy-id k8s@m7-devops-128107
[k8s@m7-devops-128071 k8s]$ ssh-copy-id k8s@m7-devops-128123
```
...
sudo vim /etc/default/grub # 添加 `numa=off` 参数
