...
[Service]
WorkingDirectory=/mnt/disk1/k8s/kube-apiserver
ExecStart=/opt/k8s/bin/kube-apiserver \\
  ...
  --audit-log-path=/mnt/disk1/k8s/kube-apiserver/audit.log \\
  --event-ttl=168h \\
  --alsologtostderr=true \\
  --logtostderr=false \\
  --log-dir=/mnt/disk1/k8s/kube-apiserver/log \\
  --v=2
Restart=on-failure
RestartSec=5
Type=notify
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "mkdir -p /mnt/disk1/k8s/kube-apiserver/log"
...
tcp        0      0 172.27.128.120:6443      0.0.0.0:*               LISTEN      7003/kube-apiserver
```
