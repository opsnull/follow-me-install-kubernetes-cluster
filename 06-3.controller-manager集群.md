...
ExecStart=/opt/k8s/bin/kube-controller-manager \\
  ...
  --log-dir=${K8S_DIR}/kube-controller-manager/log \\
  --v=2
Restart=on-failure
RestartSec=5
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "mkdir -p ${K8S_DIR}/kube-controller-manager/log" 
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"m7-demo-136001","leaseDurationSeconds":15,"acquireTime":"2018-08-15T14:19:35Z","renewTime":"2018-08-15T14:19:53Z","leaderTransitions":0}'
