...
ExecStart=/opt/k8s/bin/kube-controller-manager \\
  ...
  --log-dir=/mnt/disk0/k8s/kube-controller-manager/log \\
  --v=2
Restart=on-failure
RestartSec=5
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "mkdir -p /mnt/disk0/k8s/kube-controller-manager/log" 
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"m7-devops-128071","leaseDurationSeconds":15,"acquireTime":"2018-07-24T12:41:08Z","renewTime":"2018-07-24T12:43:03Z","leaderTransitions":0}'
  creationTimestamp: 2018-07-24T12:41:08Z
  name: kube-controller-manager
  namespace: kube-system
  resourceVersion: "229"
  selfLink: /api/v1/namespaces/kube-system/endpoints/kube-controller-manager
  uid: d6c68faa-8f3e-11e8-8b95-0cc47a2af650
subsets: null
```

可见，当前的 leader 为 m7-devops-128107 节点。
