...
[Service]
WorkingDirectory=/mnt/disk1/k8s/kube-scheduler
ExecStart=/opt/k8s/bin/kube-scheduler \\
  ...
  --log-dir=/mnt/disk1/k8s/kube-scheduler/log \\
  --v=2
Restart=on-failure
RestartSec=5
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "mkdir -p /mnt/disk1/k8s/kube-scheduler/log"
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"m7-demo-128120","leaseDurationSeconds":15,"acquireTime":"2018-08-15T14:22:00Z","renewTime":"2018-08-15T14:22:13Z","leaderTransitions":0}'
