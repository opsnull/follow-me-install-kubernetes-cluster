...
ls kubelet-bootstrap-*.kubeconfig
```
...
4ef7hj.x3atclw09sq56lfx   23h       2018-08-16T12:04:38+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-autocv-gpu01
8galm1.o8dx3yxhy4zcde4w   23h       2018-08-16T12:04:39+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-autocv-gpu03
ai162m.y1nitq3rcelhl9c9   23h       2018-08-16T12:04:39+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-autocv-gpu02
```
...
bootstrap-token-4ef7hj                           bootstrap.kubernetes.io/token         7         58s
bootstrap-token-8galm1                           bootstrap.kubernetes.io/token         7         57s
bootstrap-token-ai162m                           bootstrap.kubernetes.io/token         7         57s
```
...
tcp        0      0 127.0.0.1:36024         0.0.0.0:*               LISTEN      7807/kubelet
tcp        0      0 127.0.0.1:10248         0.0.0.0:*               LISTEN      7807/kubelet
tcp        0      0 172.27.128.150:10250    0.0.0.0:*               LISTEN      7807/kubelet
```
