...
c77gx4.fofw4ir1628c6zk8   23h       2018-11-29T16:54:27+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-inf-prod01
em63m9.g4cemcarph6gz6vg   23h       2018-11-29T16:54:32+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-common-dfs03
mnpn4i.iqttdxlan650stmu   23h       2018-11-29T16:54:35+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:m7-common-dfs02
```
...
m7-common-dfs02   Ready    <none>   4m12s   v1.12.3
m7-common-dfs03   Ready    <none>   4m13s   v1.12.3
m7-inf-prod01     Ready    <none>   12s     v1.12.3
```
...
$ kubectl get csr
NAME                                                   AGE     REQUESTOR                     CONDITION
csr-lrhk2                                              9m25s   system:node:m7-common-dfs02   Pending
csr-pkglb                                              5m24s   system:node:m7-inf-prod01     Pending
csr-xdgcl                                              9m25s   system:node:m7-common-dfs03   Pending
...
tcp        0      0 172.27.128.179:10250    0.0.0.0:*               LISTEN      73487/kubelet
```
...
$ sudo curl -s --cacert /etc/kubernetes/cert/ca.pem --cert /opt/k8s/work/admin.pem --key /opt/k8s/work/admin-key.pem https://172.27.128.179:10250/metrics|head
