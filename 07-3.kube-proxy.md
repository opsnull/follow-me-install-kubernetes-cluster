...
ExecStart=/opt/k8s/bin/kube-proxy \\
  ...
  --log-dir=/mnt/disk0/k8s/kube-proxy/log \\
  --v=2
Restart=on-failure
RestartSec=5
LimitNOFILE=65536
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "mkdir -p /mnt/disk0/k8s/kube-proxy/log"
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    ssh root@${node_ip} "rm -rf /mnt/disk0/k9s "
  done
...
tcp        0      0 172.27.128.71:10249     0.0.0.0:*               LISTEN      22206/kube-proxy
tcp        0      0 172.27.128.71:10256     0.0.0.0:*               LISTEN      22206/kube-proxy
```
