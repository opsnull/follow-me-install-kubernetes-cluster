...
``` bash
[work@m7-demo-128119 ~]$ ls -l /tmp/cuda-repo-rhel7-9-2-*
...
``` bash
[root@m7-demo-128120 deviceQuery]# cat /etc/ld.so.conf.d/cuda-9-2.conf
...
``` bash
[root@m7-demo-128120 ~]#  cat /proc/driver/nvidia/version
...
``` bash
[root@m7-demo-128120 ~]# cd /usr/local/cuda-9.2/samples/1_Utilities/deviceQuery
[root@m7-demo-128120 deviceQuery]# make clean && make
.[root@m7-demo-128120 deviceQuery]# ./deviceQuery
```
...
``` bash
[root@m7-demo-128120 deviceQuery]# sudo nvidia-smi
```
