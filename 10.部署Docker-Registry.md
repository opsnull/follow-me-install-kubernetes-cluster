...
[k8s@zhangjun-k8s01 cert]$ python s3test.py
...
1. ceph-deploy config push zhangjun-k8s01 zhangjun-k8s02 zhangjun-k8s03
1.  systemctl restart 'ceph-mds@zhangjun-k8s03.service'
    systemctl restart ceph-osd@0
    systemctl restart 'ceph-mon@zhangjun-k8s01.service'
    systemctl restart 'ceph-mgr@zhangjun-k8s01.service'
...
[root@zhangjun-k8s01 ~]# docker login  172.27.132.67:8000
Username: foo
Password:
