...
[root@m7-devops-128071 k8s]# scp root@172.27.128.100:/etc/ceph/ceph.client.admin.keyring /etc/ceph/

[root@m7-devops-128071 k8s]# cat /etc/ceph/ceph.client.admin.keyring
[client.admin]
...
[root@m7-devops-128071 k8s]# awk '/key = / {print $3}' /etc/ceph/ceph.client.admin.keyring >/etc/ceph/ceph-admin.secret
[root@m7-devops-128071 k8s]# mount -t ceph 172.27.128.100:6789:/k8s/devops  /mnt/cephfs/k8s/devops -o name=admin,secretfile=/etc/ceph/ceph-admin.secret
