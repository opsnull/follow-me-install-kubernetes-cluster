...
这里以添加 Work 节点 m7-power-128013 (172.27.128.13) 为例，定义主机名和 IP 环境变量：

``` bash
export NODE_IP=172.27.128.13
export NODE_NAME=m7-power-128013
```
...
``` bash
m7-power-128013   Ready     <none>    5m        v1.8.15
```
