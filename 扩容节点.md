...
这里以添加 Work 节点 m7-devops-128109 (172.27.128.109) 为例，定义主机名和 IP 环境变量：

``` bash
export NODE_IP=172.27.128.109
export NODE_NAME=m7-devops-128109
```
...
``` bash
m7-devops-128109   Ready     <none>    5m        v1.8.15
```
